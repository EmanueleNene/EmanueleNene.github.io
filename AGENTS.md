...
- `gym/`: FerroDaStiro, a standalone installable PWA workout tracker, hosted at `/gym/` and self-contained (own `index.html`, `sw.js`, `manifest.webmanifest`, `CLAUDE.md`, `README.md`).
